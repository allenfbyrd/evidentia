"""DEPRECATED — controlbridge-api has been renamed to evidentia-api.

This transitional shim re-exports everything from `evidentia_api` and aliases
every submodule into `controlbridge_api.*` via `sys.modules`, so pre-rename imports
like `from controlbridge_api.submodule import Foo` continue to work.
...
Then rewrite `controlbridge_api` to `evidentia_api` in your imports.
"""
...
_OLD_PYPI = "controlbridge-api"
_NEW_PYPI = "evidentia-api"
_OLD_MODULE = "controlbridge_api"
_NEW_MODULE = "evidentia_api"
