"""DEPRECATED — controlbridge-ai has been renamed to evidentia-ai.

This transitional shim re-exports everything from `evidentia_ai` and aliases
every submodule into `controlbridge_ai.*` via `sys.modules`, so pre-rename imports
like `from controlbridge_ai.submodule import Foo` continue to work.
...
Then rewrite `controlbridge_ai` to `evidentia_ai` in your imports.
"""
...
_OLD_PYPI = "controlbridge-ai"
_NEW_PYPI = "evidentia-ai"
_OLD_MODULE = "controlbridge_ai"
_NEW_MODULE = "evidentia_ai"
