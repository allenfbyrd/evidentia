...
(:func:`evidentia_ai.eval.faithfulness.faithfulness_score`) with a
...
References:
- :class:`evidentia_ai.eval.faithfulness.FaithfulnessResult` —
...
def faithfulness_score_semantic(
    ...
    *,
    ...
    Mirrors the API of
    :func:`evidentia_ai.eval.faithfulness.faithfulness_score` but
