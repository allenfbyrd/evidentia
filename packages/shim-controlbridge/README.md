# controlbridge (DEPRECATED)

**This package has been renamed to [`evidentia`](https://pypi.org/project/evidentia/).**
...
import to `evidentia`. It will be **removed in v0.7.0 (~October 2026)**.

## Migration

```bash
pip uninstall controlbridge
...
from controlbridge.submodule import Thing

# after
import evidentia
from evidentia.submodule import Thing
```
