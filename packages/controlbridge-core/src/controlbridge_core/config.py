...
v0.4.0 moves this module from ``controlbridge.config`` to
``controlbridge_core.config`` so both the CLI meta-package
(``controlbridge``) and the API backend (``controlbridge-api``) can
