"""OSCAL exporters for ControlBridge models.

Maps ControlBridge gap reports to OSCAL Assessment Results (AR) JSON.
...
def gap_report_to_oscal_ar(report: GapAnalysisReport) -> dict[str, Any]:
    """Convert a ControlBridge gap report to an OSCAL Assessment Results dict.
    ...
    return {
        "assessment-results": {
            ...
            "results": [
                {
                    "uuid": result_uuid,
                    "title": "ControlBridge Gap Analysis Result",
                    "description": (
