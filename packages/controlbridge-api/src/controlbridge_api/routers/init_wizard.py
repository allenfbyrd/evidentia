...
Wraps :mod:`controlbridge_core.init_wizard` for browser use. The client
...
from controlbridge_api.schemas import InitWizardRequest, InitWizardResponse
...
async def init_wizard(payload: InitWizardRequest) -> InitWizardResponse:
    ...
    cb_yaml = generate_controlbridge_yaml(
