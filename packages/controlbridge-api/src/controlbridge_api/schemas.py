...
Response models reuse core ControlBridge types from ``controlbridge_core.models``
...
class HealthResponse(BaseModel):
    ...
    version: str = Field(description="Installed ControlBridge API version.")
