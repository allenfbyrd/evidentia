 ...
 * Home page when no `controlbridge.yaml` exists yet.
 */
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              ...
              3 frameworks). The fastest way to see what ControlBridge does —
              no setup required.
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              ...
              exported from another tool. ControlBridge auto-detects the
              format.
            </CardDescription>
          </CardHeader>
          <CardContent>
